...
export default function TransitionsModal(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    const requestBody = {
      ...
      toemail: "info@novagroovegood.com",
      subject: "Contact Form Submission from Nova Groove Good",
    };

    try {
      const res = await fetch(
        "https://proxy-nodejs-one.vercel.app/api/api/websitecontact",
        {
          method: "POST",
          headers: {
      ...
      >
        <Fade in={openModal}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <Button onClick={closeModal} style={{ minWidth: 'auto' }} className="modal-close-btn">
